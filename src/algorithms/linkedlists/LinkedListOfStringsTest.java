...
public class LinkedListOfStringsTest {
	...
	public void addNodes() {
		testLinkedList = new LinkedListOfStrings("A0","A1","A2","A3","A4","A5","A6","A7","A8","A9");
	}
	...
	public void testContains() {
		...
		assertTrue("Contains should return true when the String name is present in the list", testLinkedList.contains(new Node<String>("A0")));
		assertTrue("Contains should return true when the String name is present in the list", testLinkedList.contains(new Node<String>("A4")));
		assertTrue("Contains should return true when the String name is present in the list", testLinkedList.contains(new Node<String>("A9")));
		testLinkedList.add(new Node<String>("A10"));
		assertTrue("Contains should return true when the String name is present in the list", testLinkedList.contains(new Node<String>("A10")));
		assertFalse("Contains should only return true for perfect String matches", testLinkedList.contains(new Node<String>("A88")));
		assertFalse("Contains shouldn't return true if the String name isn't present in the list", testLinkedList.contains(new Node<String>("B5")));
	}
	...
	public void testRemoveNode() {
		...
		assertTrue(testLinkedList.remove(new Node<String>("A0")));
		testHelperRemoveNodeFromFront();
		
		addNodes();
		assertTrue(testLinkedList.remove(new Node<String>("A5")));
		testHelperRemoveNodeFromMiddle();
		
		addNodes();
		assertTrue(testLinkedList.remove(new Node<String>("A9")));
		testHelperRemoveNodeFromEnd();
		
		// ***Test removing invalid node -- check returned false, check size, check Nodes unchanged
		addNodes();
		assertFalse(testLinkedList.remove(new Node<String>("A11")));
	...
	public void testSet() {
		try {
			testLinkedList.set(10, new Node<String>("Blah"));
			fail("set: Invalid index should have triggered IndexOutOfBoundsException");
		} 	
		catch (IndexOutOfBoundsException e) {}//passed 
		try {
			testLinkedList.set(-1, new Node<String>("Blah"));
			fail("set: Invalid index should have triggered IndexOutOfBoundsException");
		} 	
		catch (IndexOutOfBoundsException e) {}//passed
		...
		addNodes();
		Node<String> returnedNode = testLinkedList.set(0, new Node<String>("B0"));
		...
		addNodes();
		returnedNode = testLinkedList.set(3, new Node<String>("B3"));
